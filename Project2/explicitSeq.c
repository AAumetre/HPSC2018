...
int main(int argc, char *argv[])
{
  ...
  FILE *fp;
   ...
   fclose(fp);
   // quand ce sera en parallèle, c'est pareil sauf qu'il faut utiliser fseek pour dire que le process 1 écrit après les écritures du process 0 etc.
